...
public class ADFExperiment {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, JSONException {
        //sequence workflows
        String appname = "ADFSequence5Payload2-5";
        String url = "******";
        String outputFile = "******";
        for (int j = 1; j <= 25; j++) {
            try {
     ...
     /*
        String path = "******";
        String appid = "******";
        String appname = "ADFSequence5Payload2-20";
...
//parallel
       ...
       /* String appname = "ADFParallel5Payload2-10";
        String url = "******";
        String outputFile = "******";
        for (int j = 1; j <= 24; j++) {
            try {
...
//        String path = "******";
//        String appid = "******";
//        String appname = "ADFParallel5Payload2-15-2";
//        String startorchestrator = "\"traces | where message contains 'Executing \\'Functions.HelloOrchestrator\\' ' | sort by timestamp asc |summarize min(timestamp)\"";
//        String endorchestrator = "\"traces | where message contains 'Executed \\'Functions.HelloOrchestrator\\' ' | sort by timestamp asc |summarize max(timestamp)\"";
